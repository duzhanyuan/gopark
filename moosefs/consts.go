...
const ANTOCS_CHUNK_CHECKSUM_TAB = 302
...
const FUSE_REGISTER_BLOB_NOACL = "kFh9mdZsR84l5e675v8bi54VfXaXSYozaU3DSz9AsLLtOtKipzb9aQNkxeOISx64"
...
const FUSE_REGISTER_BLOB_TOOLS_NOACL = "kFh9mdZsR84l5e675v8bi54VfXaXSYozaU3DSz9AsLLtOtKipzb9aQNkxeOISx63"
...
const REGISTER_NEWMETASESSION = 5
...
const CUTOMA_FUSE_REGISTER = 400

// blob:64B ... (depends on blob - see blob descriptions above
const MATOCU_FUSE_REGISTER = 401

// depends on blob - see blob descriptions above
const CUTOMA_FUSE_STATFS = 402

// msgid:32 -
const MATOCU_FUSE_STATFS = 403

// msgid:32 totalspace:64 availspace:64 trashspace:64 inodes:32
const CUTOMA_FUSE_ACCESS = 404

// msgid:32 inode:32 uid:32 gid:32 modemask:8
const MATOCU_FUSE_ACCESS = 405

// msgid:32 status:8
const CUTOMA_FUSE_LOOKUP = 406

// msgid:32 inode:32 name:NAME uid:32 gid:32
const MATOCU_FUSE_LOOKUP = 407

// msgid:32 status:8
// msgid:32 inode:32 attr:35B
const CUTOMA_FUSE_GETATTR = 408

// msgid:32 inode:32
// msgid:32 inode:32 uid:32 gid:32
const MATOCU_FUSE_GETATTR = 409

// msgid:32 status:8
// msgid:32 attr:35B
const CUTOMA_FUSE_SETATTR = 410
...
const MATOCU_FUSE_SETATTR = 411

// msgid:32 status:8
// msgid:32 attr:35B
const CUTOMA_FUSE_READLINK = 412

// msgid:32 inode:32
const MATOCU_FUSE_READLINK = 413

// msgid:32 status:8
// msgid:32 length:32 path:lengthB
const CUTOMA_FUSE_SYMLINK = 414

// msgid:32 inode:32 name:NAME length:32 path:lengthB uid:32 gid:32
const MATOCU_FUSE_SYMLINK = 415

// msgid:32 status:8
// msgid:32 inode:32 attr:35B
const CUTOMA_FUSE_MKNOD = 416

// msgid:32 inode:32 name:NAME type:8 mode:16 uid:32 gid:32 rdev:32
const MATOCU_FUSE_MKNOD = 417

// msgid:32 status:8
// msgid:32 inode:32 attr:35B
const CUTOMA_FUSE_MKDIR = 418

// msgid:32 inode:32 name:NAME mode:16 uid:32 gid:32
const MATOCU_FUSE_MKDIR = 419

// msgid:32 status:8
// msgid:32 inode:32 attr:35B
const CUTOMA_FUSE_UNLINK = 420

// msgid:32 inode:32 name:NAME uid:32 gid:32
const MATOCU_FUSE_UNLINK = 421

// msgid:32 status:8
const CUTOMA_FUSE_RMDIR = 422

// msgid:32 inode:32 name:NAME uid:32 gid:32
const MATOCU_FUSE_RMDIR = 423

// msgid:32 status:8
const CUTOMA_FUSE_RENAME = 424

// msgid:32 inode_src:32 name_src:NAME inode_dst:32 name_dst:NAME uid:32 gid:32
const MATOCU_FUSE_RENAME = 425

// msgid:32 status:8
const CUTOMA_FUSE_LINK = 426

// msgid:32 inode:32 inode_dst:32 name_dst:NAME uid:32 gid:32
const MATOCU_FUSE_LINK = 427

// msgid:32 status:8
// msgid:32 inode:32 attr:35B
const CUTOMA_FUSE_GETDIR = 428

// msgid:32 inode:32 uid:32 gid:32 - old version (works like new version with flags==0
// msgid:32 inode:32 uid:32 gid:32 flags:8
const MATOCU_FUSE_GETDIR = 429
...
const CUTOMA_FUSE_OPEN = 430

// msgid:32 inode:32 uid:32 gid:32 flags:8
const MATOCU_FUSE_OPEN = 431

// msgid:32 status:8
// since 1.6.9 if no error:
// msgid:32 attr:35B

const CUTOMA_FUSE_READ_CHUNK = 432

// msgid:32 inode:32 chunkindx:32
const MATOCU_FUSE_READ_CHUNK = 433
...
const CUTOMA_FUSE_WRITE_CHUNK = 434 // it creates, duplicates or sets new version of chunk if necessary */
// msgid:32 inode:32 chunkindx:32
const MATOCU_FUSE_WRITE_CHUNK = 435

// msgid:32 status:8
// msgid:32 length:64 chunkid:64 version:32 N*[ip:32 port:16]
const CUTOMA_FUSE_WRITE_CHUNK_END = 436

// msgid:32 chunkid:64 inode:32 length:64
const MATOCU_FUSE_WRITE_CHUNK_END = 437

// msgid:32 status:8

const CUTOMA_FUSE_APPEND = 438

// msgid:32 inode:32 srcinode:32 uid:32 gid:32 - append to existing element
const MATOCU_FUSE_APPEND = 439

// msgid:32 status:8

const CUTOMA_FUSE_CHECK = 440

// msgid:32 inode:32
const MATOCU_FUSE_CHECK = 441

// msgid:32 status:8
// msgid:32 N*[ copies:8 chunks:16 ]

const CUTOMA_FUSE_GETTRASHTIME = 442

// msgid:32 inode:32 gmode:8
const MATOCU_FUSE_GETTRASHTIME = 443

// msgid:32 status:8
// msgid:32 tdirs:32 tfiles:32 tdirs*[ trashtime:32 dirs:32 ] tfiles*[ trashtime:32 files:32 ]
const CUTOMA_FUSE_SETTRASHTIME = 444

// msgid:32 inode:32 uid:32 trashtimeout:32 smode:8
const MATOCU_FUSE_SETTRASHTIME = 445

// msgid:32 status:8
// msgid:32 changed:32 notchanged:32 notpermitted:32

const CUTOMA_FUSE_GETGOAL = 446

// msgid:32 inode:32 gmode:8
const MATOCU_FUSE_GETGOAL = 447

// msgid:32 status:8
// msgid:32 gdirs:8 gfiles:8 gdirs*[ goal:8 dirs:32 ] gfiles*[ goal:8 files:32 ]

const CUTOMA_FUSE_SETGOAL = 448

// msgid:32 inode:32 uid:32 goal:8 smode:8
const MATOCU_FUSE_SETGOAL = 449

// msgid:32 status:8
// msgid:32 changed:32 notchanged:32 notpermitted:32

const CUTOMA_FUSE_GETTRASH = 450

// msgid:32
const MATOCU_FUSE_GETTRASH = 451

// msgid:32 status:8
// msgid:32 N*[ name:NAME inode:32 ]

const CUTOMA_FUSE_GETDETACHEDATTR = 452

// msgid:32 inode:32 dtype:8
const MATOCU_FUSE_GETDETACHEDATTR = 453

// msgid:32 status:8
// msgid:32 attr:35B

const CUTOMA_FUSE_GETTRASHPATH = 454

// msgid:32 inode:32
const MATOCU_FUSE_GETTRASHPATH = 455

// msgid:32 status:8
// msgid:32 length:32 path:lengthB

const CUTOMA_FUSE_SETTRASHPATH = 456

// msgid:32 inode:32 length:32 path:lengthB
const MATOCU_FUSE_SETTRASHPATH = 457

// msgid:32 status:8

const CUTOMA_FUSE_UNDEL = 458

// msgid:32 inode:32
const MATOCU_FUSE_UNDEL = 459

// msgid:32 status:8
const CUTOMA_FUSE_PURGE = 460

// msgid:32 inode:32
const MATOCU_FUSE_PURGE = 461

// msgid:32 status:8

const CUTOMA_FUSE_GETDIRSTATS = 462

// msgid:32 inode:32
const MATOCU_FUSE_GETDIRSTATS = 463

// msgid:32 status:8
// msgid:32 inodes:32 dirs:32 files:32 ugfiles:32 mfiles:32 chunks:32 ugchunks:32 mchunks32 length:64 size:64 gsize:64

const CUTOMA_FUSE_TRUNCATE = 464

// msgid:32 inode:32 [opened:8] uid:32 gid:32 opened:8 length:64
const MATOCU_FUSE_TRUNCATE = 465

// msgid:32 status:8
// msgid:32 attr:35B

const CUTOMA_FUSE_REPAIR = 466

// msgid:32 inode:32 uid:32 gid:32
const MATOCU_FUSE_REPAIR = 467

// msgid:32 status:8
// msgid:32 notchanged:32 erased:32 repaired:32

const CUTOMA_FUSE_SNAPSHOT = 468

// msgid:32 inode:32 inode_dst:32 name_dst:NAME uid:32 gid:32 canoverwrite:8
const MATOCU_FUSE_SNAPSHOT = 469

// msgid:32 status:8

const CUTOMA_FUSE_GETRESERVED = 470

// msgid:32
const MATOCU_FUSE_GETRESERVED = 471

// msgid:32 status:8
// msgid:32 N*[ name:NAME inode:32 ]

const CUTOMA_FUSE_GETEATTR = 472

// msgid:32 inode:32 gmode:8
const MATOCU_FUSE_GETEATTR = 473

// msgid:32 status:8
// msgid:32 eattrdirs:8 eattrfiles:8 eattrdirs*[ eattr:8 dirs:32 ] eattrfiles*[ eattr:8 files:32 ]

const CUTOMA_FUSE_SETEATTR = 474

// msgid:32 inode:32 uid:32 eattr:8 smode:8
const MATOCU_FUSE_SETEATTR = 475

// msgid:32 status:8
// msgid:32 changed:32 notchanged:32 notpermitted:32

const CUTOMA_FUSE_QUOTACONTROL = 476
...
const MATOCU_FUSE_QUOTACONTROL = 477
...
const CUTOMA_FUSE_DIR_REMOVED = 490

// msgid:32 N*[ inode:32 ]

const MATOCU_FUSE_NOTIFY_ATTR = 491

// msgid:32 N*[ parent:32 inode:32 attr:35B ]
const MATOCU_FUSE_NOTIFY_DIR = 492

// msgid:32 N*[ inode:32 ]
// special - reserved (opened) inodes - keep opened files.
const CUTOMA_FUSE_RESERVED_INODES = 499
